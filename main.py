...
class Puck(object):
    ...
    def drawPuck(self):
        pygame.draw.circle(screen, green, [self.x, self.y], 15, 10)
...
class Mallet(object):
    def __init__(self, malletType, x, y, uLim=50, bLim=65, lLim=50, rLim=450, dx=0, dy=0):
        self.x = x
        self.y = y
        self.last_x = self.x
        self.last_y = self.y
    ...
    def drawMallet(self):
        ...
        pygame.draw.circle(screen, black, [self.x, self.y], 20, 0)
